...
struct macs{
  unsigned char mac[6] = {0xe2, 0x41, 0x36, 0x68,0xad, 0x10};
  unsigned char mac2[6] = {0xe2, 0x41, 0x36, 0x68, 0xad, 0x11};
};
...
void loop() {
  ...
  SerialUSB.print("Size "+ sizeof(macs));
  answer = sendSigfox(&frame2, sizeof(macs));
